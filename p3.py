...
WindowNameSublime='C:\\Users\\8holz\\Documents\\GitHub\\K14\\p3.py - Sublime Text (UNREGISTERED)'
count=0
st=None
...
def screenshot(window_title=None, factorx=0, factory=0):
    if window_title:
        ...
        if hwnd:
            ...
            x, y, x1, y1 = GetClientRect(hwnd)#Grösse/nicht position
